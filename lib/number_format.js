...
var NumberFormat = /*#__PURE__*/function (_React$Component) {
  ...
  _createClass(NumberFormat, [{
    ...
    value: function render() {
      ...
      var inputMode = (0, _utils.addInputMode)(format) ? 'numeric' : undefined;
      ...
      if (displayType === 'text') {
        return renderText ? renderText(value) || null : /*#__PURE__*/_react["default"].createElement("span", _extends({}, otherProps, {
          ref: getInputRef
        }), value);
      } else if (customInput) {
        var CustomInput = customInput;
        return /*#__PURE__*/_react["default"].createElement(CustomInput, _extends({}, inputProps, {
          ref: getInputRef
        }));
      }
